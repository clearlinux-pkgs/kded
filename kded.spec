...
Source0  : https://download.kde.org/stable/frameworks/5.113/kded-5.113.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.113/kded-5.113.0.tar.xz.sig
...
%prep
%setup -q -n kded-5.113.0
cd %{_builddir}/kded-5.113.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703008616
mkdir -p clr-build
pushd clr-build
