...
Source0  : https://download.kde.org/stable/frameworks/5.93/kded-5.93.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.93/kded-5.93.0.tar.xz.sig
...
%prep
%setup -q -n kded-5.93.0
cd %{_builddir}/kded-5.93.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650897183
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kded-5.93.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kded/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kded-5.93.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kded/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kded-5.93.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kded/20079e8f79713dce80ab09774505773c926afa2a
pushd clr-build
%make_install
popd
