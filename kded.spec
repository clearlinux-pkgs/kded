...
Version  : 6.1.0
Release  : 226
URL      : https://download.kde.org/stable/frameworks/6.1/kded-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.1/kded-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kded-6.1.0.tar.xz.sig
...
%setup -q -n kded-6.1.0
cd %{_builddir}/kded-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712968703
mkdir -p clr-build
pushd clr-build
