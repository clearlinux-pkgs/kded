...
Version  : 5.103.0
Release  : 147
URL      : https://download.kde.org/stable/frameworks/5.103/kded-5.103.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.103/kded-5.103.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.103/kded-5.103.0.tar.xz.sig
...
%prep
%setup -q -n kded-5.103.0
cd %{_builddir}/kded-5.103.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676328015
mkdir -p clr-build
pushd clr-build
