...
Version  : 6.2.0
Release  : 227
URL      : https://download.kde.org/stable/frameworks/6.2/kded-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.2/kded-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/kded-6.2.0.tar.xz.sig
...
%setup -q -n kded-6.2.0
cd %{_builddir}/kded-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715638483
mkdir -p clr-build
pushd clr-build
