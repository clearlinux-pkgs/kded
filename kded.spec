...
Version  : 6.3.0
Release  : 229
URL      : https://download.kde.org/stable/frameworks/6.3/kded-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.3/kded-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/kded-6.3.0.tar.xz.sig
...
%setup -q -n kded-6.3.0
cd %{_builddir}/kded-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717791938
mkdir -p clr-build
pushd clr-build
