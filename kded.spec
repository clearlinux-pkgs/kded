...
Source0  : https://download.kde.org/stable/frameworks/6.0/kded-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/kded-6.0.0.tar.xz.sig
...
%prep
%setup -q -n kded-6.0.0
cd %{_builddir}/kded-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709242069
mkdir -p clr-build
pushd clr-build
