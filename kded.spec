...
Version  : 6.11.0
Release  : 239
URL      : https://download.kde.org/stable/frameworks/6.11/kded-6.11.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.11/kded-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/kded-6.11.0.tar.xz.sig
...
%setup -q -n kded-6.11.0
cd %{_builddir}/kded-6.11.0
pushd ..
cp -a kded-6.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739577552
mkdir -p clr-build
pushd clr-build
