...
Version  : 5.114.0
Release  : 220
URL      : https://download.kde.org/stable/frameworks/5.114/kded-5.114.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.114/kded-5.114.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.114/kded-5.114.0.tar.xz.sig
...
%prep
%setup -q -n kded-5.114.0
cd %{_builddir}/kded-5.114.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705455703
mkdir -p clr-build
pushd clr-build
